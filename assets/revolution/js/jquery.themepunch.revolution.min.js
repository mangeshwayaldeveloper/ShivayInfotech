...
!(function (jQuery, undefined) {
  ...
  jQuery.fn.extend({
            ...
            jQuery(this).on("scriptsloaded", function () {
              return e.modulesfailing
                ? (t
                    ...
                    .show(),
                  !1)
                : (_R.migration != undefined && (e = _R.migration(t, e)),
                  (punchgs.force3D = !0),
                  "on" !== e.simplifyAll &&
        ...
        if (
          ...
          if (n && n.li.length > 0 && (e > 0 || e <= n.li.length)) {
            ...
            (n.slideamount = n.slideamount - 1),
              ...
              n.carousel &&
                n.carousel.slides &&
                (n.carousel.slides = removeArray(n.carousel.slides, e)),
    ...
    revkill: function (e) {
      ...
      if (
        ...
        _R.endMoveCaption &&
          a.endtimeouts &&
          a.endtimeouts.length > 0 &&
          jQuery.each(a.endtimeouts, function (e, t) {
            clearTimeout(t);
          }),
        i != undefined &&
          i.length > 0 &&
    ...
    revstart: function () {
      ...
      return e != undefined &&
        ...
        jQuery("body").find("#" + e.attr("id")).length > 0 &&
        e.data("opt")
        ? e.data("opt").sliderisrunning
          ? (console.log("Slider Is Running Already"), !1)
          : (runSlider(e, e.data("opt")), !0)
        : void 0;
    },
    revnext: function () {
      return this.each(function () {
  ...
  jQuery.extend(!0, _R, {
    ...
    callBackHandling: function (e, t, i) {
      try {
        e.callBackArray &&
          jQuery.each(e.callBackArray, function (e, n) {
            n &&
              n.inmodule &&
              n.inmodule === t &&
              n.atposition &&
    ...
    callingNewSlide: function (e, t, i) {
      var n =
          t.find(".next-revslide").length > 0
            ? t.find(".next-revslide").index()
            : t.find(".processing-revslide").length > 0
            ? t.find(".processing-revslide").index()
            : t.find(".active-revslide").index(),
        a = 0;
      t.find(".next-revslide").removeClass("next-revslide"),
        t.find(".active-revslide").hasClass("tp-invisible-slide") &&
          (n = e.last_shown_slide),
        (i && jQuery.isNumeric(i)) || i.match(/to/g)
          ? (1 === i || -1 === i
              ? ((a = n + i),
                (a = 0 > a ? e.slideamount - 1 : a >= e.slideamount ? 0 : a))
              : ((i = jQuery.isNumeric(i) ? i : parseInt(i.split("to")[1], 0)),
                (a =
                  0 > i ? 0 : i > e.slideamount - 1 ? e.slideamount - 1 : i)),
            t
              .find(".tp-revslider-slidesli:eq(" + a + ")")
              .addClass("next-revslide"))
          : i &&
            t.find(".tp-revslider-slidesli").each(function () {
              var e = jQuery(this);
              e.data("index") === i && e.addClass("next-revslide");
            }),
        (a = t.find(".next-revslide").index()),
        t.trigger("revolution.nextslide.waiting"),
        (n === a && n === e.last_shown_slide) || (a !== n && -1 != a)
          ? swapSlide(t, e)
          : t.find(".next-revslide").removeClass("next-revslide");
    },
    slotSize: function (e, t) {
      (t.slotw = Math.ceil(t.width / t.slots)),
        "fullscreen" == t.sliderLayout
          ? (t.sloth = Math.ceil(jQuery(window).height() / t.slots))
          : (t.sloth = Math.ceil(t.height / t.slots)),
        "on" == t.autoHeight &&
          e !== undefined &&
          "" !== e &&
          (t.sloth = Math.ceil(e.height() / t.slots));
    },
    setSize: function (e) {
        ...
        if (e.fullScreenOffsetContainer != undefined) {
          ...
          try {
            ...
            e.fullScreenOffset.length > 0
              ...
              : e.fullScreenOffset != undefined &&
                e.fullScreenOffset.length > 0 &&
                (r -= parseInt(e.fullScreenOffset, 0));
          } catch (s) {}
        }
    ...
    enterInViewPort: function (e) {
      e.waitForCountDown && (countDown(e.c, e), (e.waitForCountDown = !1)),
        e.waitForFirstSlide && (swapSlide(e.c, e), (e.waitForFirstSlide = !1)),
        ...
        e.lastplayedvideos != undefined &&
          ...
          jQuery.each(e.lastplayedvideos, function (t, i) {
            _R.playVideo(i, e);
          });
    },
    leaveViewPort: function (e) {
      (e.sliderlaststatus = e.sliderstatus),
        ...
        e.playingvideos != undefined &&
          ...
          e.playingvideos &&
            jQuery.each(e.playingvideos, function (t, i) {
  ...
  var _ISM = _R.is_mobile(),
    ...
    getNeededScripts = function (e, t) {
      ...
      return (
        ...
        (i.layeranim = !1),
        (i.migration = !1),
        t.data("version") && t.data("version").toString().match(/5./gi)
          ? (t.find("img").each(function () {
              "on" == jQuery(this).data("kenburns") && (i.kenburns = !0);
            }),
            ("carousel" == e.sliderType ||
              "on" == n.keyboardNavigation ||
              "on" == n.mouseScrollNavigation ||
              "on" == n.touch.touchenabled ||
              n.arrows.enable ||
              n.bullets.enable ||
              n.thumbnails.enable ||
              n.tabs.enable) &&
            ...
            !i.videos &&
              (t.find(".rs-background-video-layer").length > 0 ||
                t.find(".tp-videolayer").length > 0 ||
                t.find(".tp-audiolayer").length > 0 ||
                t.find("iframe").length > 0 ||
          ...
          : ((i.kenburns = !0),
            ...
            (i.layeranim = !0),
            (i.migration = !0)),
        "hero" == e.sliderType && ((i.carousel = !1), (i.navigation = !1)),
        window.location.href.match(/file:/gi) &&
          ((i.filesystem = !0), (e.filesystem = !0)),
        i.videos &&
        ...
        e.addons != undefined &&
          e.addons.length > 0 &&
          jQuery.each(e.addons, function (t, i) {
            "object" == typeof i &&
              i.fileprefix != undefined &&
              lAjax(i.fileprefix, e);
          }),
        i
      );
    },
    waitForScripts = function (e, t) {
      ...
      t.addons != undefined &&
        ...
        ("undefined" != typeof punchgs &&
          i &&
          (!n.kenburns ||
            (n.kenburns && "undefined" != typeof _R.stopKenBurn)) &&
          (!n.navigation ||
            (n.navigation && "undefined" != typeof _R.createNavigation)) &&
          (!n.carousel ||
            (n.carousel && "undefined" != typeof _R.prepareCarousel)) &&
          (!n.videos || (n.videos && "undefined" != typeof _R.resetVideo)) &&
          (!n.actions ||
            (n.actions && "undefined" != typeof _R.checkActions)) &&
          (!n.layeranim ||
            (n.layeranim && "undefined" != typeof _R.handleStaticLayers)) &&
          (!n.migration ||
            (n.migration && "undefined" != typeof _R.migration)) &&
          (!n.parallax ||
            (n.parallax && "undefined" != typeof _R.checkForParallax)) &&
          (n.carousel ||
            (!n.carousel && "undefined" != typeof _R.animateSlide)))
    ...
    setCurWinRange = function (e, t) {
      var i = 9999,
        ...
        s =
          t && 9999 == e.responsiveLevels
            ? e.visibilityLevels
            : e.responsiveLevels;
      s &&
        s.length &&
        jQuery.each(s, function (e, t) {
          t > o && (0 == n || n > t) && ((i = t), (r = e), (n = t)),
            o > t && t > n && ((n = t), (a = e));
        }),
        i > n && (r = a),
        ...
        : (container.data("aimg") != undefined &&
          ...
          opt.ul.find(">li").each(function (e) {
            ...
            "on" == t.data("hideslideonmobile") && _ISM && t.remove(),
              (t.data("invisible") || t.data("invisible") === !0) &&
                (t.addClass("tp-invisible-slide"), t.appendTo(opt.ul));
          }),
          ...
          void (
            1 != opt.waitForInit &&
            (container.data("opt", opt), runSlider(container, opt))
          ));
    },
    ...
    runSlider = function (e, t) {
      ...
      if (
        ...
        (t.conw = e.width()),
        (t.conh = e.height()),
        t.responsiveLevels.length > 1
          ? (t.responsiveLevels[0] = 9999)
          : (t.responsiveLevels = 9999),
        jQuery.each(t.allli, function (e, i) {
          ...
          if (
            ...
            (c =
              "no" == l
                ? c + ' data-start="0">'
                : c + "data-actions='" + p + '\' data-start="0">'),
              (c += '<a style="width:100%;height:100%;display:block"'),
              (c =
                "slide" != o ? c + ' target="' + s + '" href="' + o + '"' : c),
              (c +=
        ...
        (t.desktop = !navigator.userAgent.match(
      ...
      if (
        (t.shadow !== undefined &&
          t.shadow > 0 &&
          (e.parent().addClass("tp-shadow" + t.shadow),
        ...
        (h.addedyt = 0),
          ...
          e.find(".tp-caption, .rs-background-video-layer").each(function (e) {
            ...
            i.hasClass("tp-static-layer") &&
              ...
              _R.handleStaticLayers(i, t);
            var s =
              i.data("noposteronmobile") ||
              i.data("noPosterOnMobile") ||
              i.data("posteronmobile") ||
              i.data("posterOnMobile") ||
              i.data("posterOnMObile");
            ...
            p !== undefined && _R.checkActions(i, t, p),
              ...
              _ISM &&
                ((1 == n || "true" == n) &&
                  (i.data("autoplayonlyfirsttime", "false"), (n = !1)),
                (1 == a || "true" == a || "on" == a || "1sttime" == a) &&
                  (i.data("autoplay", "off"), (a = "off"))),
              i.data("videoloop", o),
              r ||
                (1 != n && "true" != n && "1sttime" != a) ||
        ...
        e.append(
          ...
          "off" !== t.parallax.type &&
            _R.checkForParallax &&
            _R.checkForParallax(e, t),
          _R.setSize(t),
          "hero" !== t.sliderType &&
            _R.createNavigation &&
            _R.createNavigation(e, t),
        ...
        (t.inviewport = !1),
          ...
          setTimeout(function () {
            "carousel" == t.sliderType &&
              ...
              !m.enable ||
              (m.enable && t.inviewport) ||
              (m.enable && !t.inviewport && "wait" == !m.outof)
                ? swapSlide(e, t)
                : (t.waitForFirstSlide = !0),
              _R.manageNavigation && _R.manageNavigation(t),
              t.slideamount > 1 &&
                (!m.enable || (m.enable && t.inviewport)
                  ? countDown(e, t)
                  : (t.waitForCountDown = !0)),
              setTimeout(function () {
        ...
        jQuery(window).on(y, function () {
          ...
          if ("fullscreen" == t.sliderLayout) {
            ...
            ("mobile" == t.fallbacks.ignoreHeightChanges && _ISM) ||
            "always" == t.fallbacks.ignoreHeightChanges
              ? ((t.fallbacks.ignoreHeightChangesSize =
                  t.fallbacks.ignoreHeightChangesSize == undefined
                    ? 0
                    : t.fallbacks.ignoreHeightChangesSize),
                (i =
                  n != t.lastwindowheight &&
                  Math.abs(n - t.lastwindowheight) >
                    t.fallbacks.ignoreHeightChangesSize))
              : (i = n != t.lastwindowheight);
          }
          (e.outerWidth(!0) != t.width || e.is(":hidden") || i) &&
            ((t.lastwindowheight = jQuery(window).height()),
            containerResized(e, t));
        }),
          hideSliderUnder(e, t),
          contWidthManager(t),
          t.fallbacks.disableFocusListener ||
            "true" == t.fallbacks.disableFocusListener ||
            t.fallbacks.disableFocusListener === !0 ||
            tabBlurringCheck(e, t);
      }
    },
    cArray = function (e, t) {
      if (!jQuery.isArray(e)) {
    ...
    checkHoverDependencies = function (e, t) {
      "sliderenter" === e.data("start") &&
        (t.layersonhover === undefined &&
          (t.c.on("tp-mouseenter", function () {
            t.layersonhover &&
              jQuery.each(t.layersonhover, function (e, i) {
                ...
                if (
                  (o.length > 0 && o.hasClass("active-revslide")) ||
                  o.hasClass("processing-revslide") ||
                  s.length > 0
                ) {
                  n != undefined && (n.pause(0), n.kill()),
    ...
    contWidthManager = function (e) {
      ...
      if (
        ...
        var i = Math.ceil(
          e.c.closest(".forcefullwidth_wrapper_tp_banner").offset().left - t
        );
    ...
    hideSliderUnder = function (e, t, i) {
      ...
      jQuery(window).width() < t.hideSliderAtLimit
        ...
        : e.is(":hidden") &&
          i &&
          (n.data("olddisplay") != undefined &&
          "undefined" != n.data("olddisplay") &&
          "none" != n.data("olddisplay")
            ? n.css({
    ...
    containerResized = function (e, t) {
      if (
        (1 == t.infullscreenmode && (t.minHeight = jQuery(window).height()),
        setCurWinRange(t),
        setCurWinRange(t, !0),
        !_R.resizeThumbsTabs || _R.resizeThumbsTabs(t) === !0)
      ) {
        if (
          (hideSliderUnder(e, t, !0),
          contWidthManager(t),
        ...
        removeSlots(e, t, e, 2),
          ...
          _R.animateTheCaptions &&
            _R.animateTheCaptions(e.find(".active-revslide"), t, !0),
          "on" == n.data("kenburns") &&
            _R.startKenBurn(n, t, n.data("kbtl").progress()),
          "on" == i.data("kenburns") &&
            _R.startKenBurn(i, t, i.data("kbtl").progress()),
          _R.animateTheCaptions &&
            _R.animateTheCaptions(n.closest("li"), t, !0),
          _R.manageNavigation && _R.manageNavigation(t);
      }
    },
    setScale = function (e) {
    ...
    prepareSlides = function (e, t) {
      if (
        ...
        t.allli.each(function (e) {
          ...
          ((t.startWithSlide != undefined && n == t.startWithSlide) ||
            (t.startWithSlide === undefined && 0 == e)) &&
      ...
      e.parent().css({
        ...
        t.allli.find(">img").each(function (e) {
          ...
          n.addClass("defaultvid").css({
            ...
            "on" == t.fallbacks.panZoomDisableOnMobile &&
              _ISM &&
          ...
          i.closest(".slotholder").data(a),
            n.length > 0 &&
              a.bgparallax != undefined &&
              n.data("bgparallax", a.bgparallax),
            "none" != t.dottedOverlay &&
              t.dottedOverlay != undefined &&
              i
                .closest(".slotholder")
                .append(
                  '<div class="tp-dottedoverlay ' + t.dottedOverlay + '"></div>'
                );
          var r = i.attr("src");
          (a.src = r),
          ...
          i.replaceWith(s),
            ...
            i.data(a),
            i.attr("src", r),
            ("standard" === t.sliderType || "undefined" === t.sliderType) &&
              i.css({
                opacity: 0,
              });
        });
    ...
    imgLoaded = function (e, t, i) {
      t.syncload--,
        t.loadqueue &&
          jQuery.each(t.loadqueue, function (t, n) {
            ...
            (r = r.substring(0, r.length - 1) + a),
              (o += a),
              (cutParams(o) === cutParams(decodeURIComponent(e.src)) ||
                ...
                cutParams(n.src) === cutParams(decodeURIComponent(e.src)) ||
                cutParams(n.src).replace(/^.*\/\/[^\/]+/, "") ===
                  cutParams(decodeURIComponent(e.src)).replace(
                    /^.*\/\/[^\/]+/,
                    ""
                  ) ||
                ("file://" === window.location.origin &&
                  cutParams(e.src).match(new RegExp(a)))) &&
                ((n.progress = i), (n.width = e.width), (n.height = e.height));
          }),
        progressImageLoad(t);
    },
    progressImageLoad = function (e) {
      3 != e.syncload &&
        e.loadqueue &&
        jQuery.each(e.loadqueue, function (t, i) {
    ...
    addToLoadQueue = function (e, t, i, n, a) {
      ...
      if (
        (t.loadqueue &&
          jQuery.each(t.loadqueue, function (t, i) {
            i.src === e && (r = !0);
          }),
        !r)
      ) {
    ...
    getLoadObj = function (e, t) {
      ...
      return (
        e.loadqueue &&
          jQuery.each(e.loadqueue, function (e, n) {
            n.src == t && (i = n);
          }),
        i
      );
      ...
      e.find("img,.defaultimg, .tp-svg-layer").each(function () {
        var i = jQuery(this),
          a =
            i.data("lazyload") != undefined
              ? i.data("lazyload")
              : i.data("svg_src") != undefined
              ? i.data("svg_src")
              : i.attr("src"),
          r = getLoadObj(t, a);
        if (
          i.data("loaded") === undefined &&
          r !== undefined &&
          r.progress &&
          ...
          if ((i.attr("src", r.src), "img" == r.type))
            ...
            "svg" == r.type &&
              "loaded" == r.progress &&
              (i.append('<div class="tp-svg-innercontainer"></div>'),
        ...
        if (
          (r &&
            ...
            (!r.error && jQuery.now() - i.data("start-to-load") < 5e3
              ? (n = !0)
              : ((r.progress = "failed"),
                r.reported_img ||
                  ((r.reported_img = !0),
                  console.warn(a + "  Could not be loaded !")))),
          1 == t.youtubeapineeded &&
          ...
          "https:" === location.protocol &&
            (d += " Please Check and Renew SSL Certificate !"),
            console.error(d),
            t.c.append(
        ...
        !_ISM &&
          ...
          jQuery.each(t.audioqueue, function (e, t) {
            t.status &&
              "prepared" === t.status &&
              jQuery.now() - t.start < t.waittime &&
              (n = !0);
          }),
    ...
    swapSlide = function (e, t) {
      if (
        (clearTimeout(t.waitWithSwapSlide),
      ...
      return n.index() === i.index()
        ...
        : (n.removeClass("next-revslide").addClass("processing-revslide"),
          n.data(
            ...
            n.data("slide_on_focus_amount") + 1 || 1
          ),
          "on" == t.stopLoop &&
            n.index() == t.lastslidetoshow - 1 &&
            (e.find(".tp-bannertimer").css({
              visibility: "hidden",
            }),
            e.trigger("revolution.slide.onstop"),
            (t.noloopanymore = 1)),
          n.index() === t.slideamount - 1 &&
            ((t.looptogo = t.looptogo - 1),
    ...
    swapSlideProgress = function (e, t, i) {
      ...
      (s.nextslide = a),
        ...
        a.data("delay") != undefined
          ? ((e.cd = 0), (e.delay = a.data("delay")))
          : (e.delay = e.origcd),
        "true" == a.data("ssop") || a.data("ssop") === !0
          ? (e.ssop = !0)
          : (e.ssop = !1),
        i.trigger("nulltimer");
      var d = n.index(),
      ...
      (e.sdir = d > l ? 1 : 0),
        "arrow" == e.sc_indicator &&
          (0 == d && l == e.slideamount - 1 && (e.sdir = 1),
      ...
      _R.scrollHandling &&
        ...
        _R.animateTheCaptions
          ? _R.animateTheCaptions(a, e, null, c)
          : c != undefined &&
            setTimeout(function () {
              c.resume();
            }, 30),
    ...
    letItFree = function (e, t, i, n, a, r, o) {
      "carousel" === t.sliderType ||
        ...
        ("scroll" == t.parallax.type ||
          "scroll+mouse" == t.parallax.type ||
          "mouse+scroll" == t.parallax.type) &&
          ((t.lastscrolltop = -999), _R.scrollHandling(t)),
        o.clear(),
        n.data("kbtl") != undefined &&
          (n.data("kbtl").reverse(), n.data("kbtl").timeScale(25)),
        "on" == i.data("kenburns") &&
        ...
        r.find(".rs-background-video-layer").each(function (e) {
          if (_ISM) return !1;
          var i = jQuery(this);
          _R.stopVideo && (_R.resetVideo(i, t), _R.stopVideo(i, t)),
            punchgs.TweenLite.to(i, 1, {
              autoAlpha: 0,
              ease: punchgs.Power3.easeInOut,
              delay: 0.2,
    ...
    countDown = function (e, t) {
      (t.cd = 0),
        (t.loop = 0),
        t.stopAfterLoops != undefined && t.stopAfterLoops > -1
          ? (t.looptogo = t.stopAfterLoops)
          : (t.looptogo = 9999999),
        t.stopAtSlide != undefined && t.stopAtSlide > -1
          ? (t.lastslidetoshow = t.stopAtSlide)
          : (t.lastslidetoshow = 999),
        (t.stopLoop = "off"),
      ...
      var n = function () {
        0 == jQuery("body").find(e).length &&
          (removeAllListeners(e, t), clearInterval(t.cdint)),
          e.trigger("revolution.slide.slideatend"),
          1 == e.data("conthover-changed") &&
            ((t.conthover = e.data("conthover")),
      ...
      i.data(
        ...
        i.data("opt", t),
        t.slideamount > 1 && (0 != t.stopAfterLoops || 1 != t.stopAtSlide)
          ? e.trigger("starttimer")
          : ((t.noloopanymore = 1), e.trigger("nulltimer")),
        e.on("tp-mouseenter", function () {
          (t.mouseoncontainer = !0),
            "on" != t.navigation.onHoverStop ||
              _ISM ||
        ...
        e.on("tp-mouseleft", function () {
          (t.mouseoncontainer = !1),
            1 != e.data("conthover") &&
              "on" == t.navigation.onHoverStop &&
              ((1 == t.viewPort.enable && t.inviewport) ||
                0 == t.viewPort.enable) &&
    ...
    restartOnFocus = function (e) {
      return e == undefined || e.c == undefined
        ? !1
        : void (
            1 != e.windowfocused &&
            ((e.windowfocused = !0),
